...
Changelog:
    ...
    - 2022-08-19 efposadac: Updated code to be used with Python3. Tested with cobbler 3.3.3
...
class CobblerInventory(object):
    ...
    def _connect(self):
        if not self.conn:
            self.conn = client.Server(self.cobbler_host, allow_none=True)
            self.token = None
